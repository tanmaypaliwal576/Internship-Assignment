...
An interactive AI-based study assistant designed to help students understand Oligopoly and related economics concepts through conversational learning, voice interaction, and curated video resources. This project was built as part of an internship assignment with a focus on clean architecture, real-world deployment, and an intuitive learning experience.

Live Demo
Link: https://oligopoly-citrine-sage-ltd.netlify.app/

Features
• Interactive study chat inspired by NotebookLM
• Context-aware AI responses based on provided study material
...
• Fully deployed frontend and backend using modern cloud platforms
